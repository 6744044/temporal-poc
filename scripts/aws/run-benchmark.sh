...
BENCH_ACTIVITY_COUNT="${BENCH_ACTIVITY_COUNT:-5}"
BENCH_LOCAL_ACTIVITY_STEPS="${BENCH_LOCAL_ACTIVITY_STEPS:-}"
...
log "  activity_count=$BENCH_ACTIVITY_COUNT"
log "  local_activity_steps=${BENCH_LOCAL_ACTIVITY_STEPS:-none}"
...
export BENCH_ACTIVITY_COUNT
export BENCH_LOCAL_ACTIVITY_STEPS
