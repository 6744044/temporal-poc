...
LOCAL_ACTIVITY_STEPS="${LOCAL_ACTIVITY_STEPS:-$BENCH_LOCAL_ACTIVITY_STEPS}"
...
log "  local_activity_steps=${LOCAL_ACTIVITY_STEPS:-none}"
...
BENCH_LOCAL_ACTIVITY_STEPS=${LOCAL_ACTIVITY_STEPS}
